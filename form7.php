...
mysqli_select_db($con,'grampanchayat');
$panchayatname=$_POST['panchayatname'];
$janpadpanchayat=$_POST['janpadpanchayat'];
$jilapanchayat=$_POST['jilapanchayat'];
$distanceblock=$_POST['distanceblock'];
$distancejila=$_POST['distancejila'];
$gramcount=$_POST['gramcount'];
$watersource=$_POST['watersource'];
$rivers=$_POST['rivers'];
$wells=$_POST['wells'];
$nistartalab=$_POST['nistartalab'];
$mukyatalab=$_POST['mukhyatalab'];
$handpumpcount=$_POST['handpumpcount'];
$tehsilname=$_POST['tehsilname'];
$headcontact=$_POST['headcontact'];
$totalrakba=$_POST['totalrakba'];
$primaryschool=$_POST['primaryschool'];
$middleschool=$_POST['middleschool'];
$highschool=$_POST['highschool'];
$malestudent=$_POST['malestudent'];
$femalestudent=$_POST['femalestudent'];
$anganwadicount=$_POST['anganwadicount'];
$policethana=$_POST['policethana'];
$policechowki=$_POST['policechowki'];
$q="insert into gram_info () values ('$panchayatname','$janpadpanchayat','$jilapanchayat','$distanceblock','$distancejila','$gramcount','$watersource','$rivers','$wells','$nistartalab','$mukyatalab','$handpumpcount','$tehsilname','$headcontact','$totalrakba','$primaryschool','$middleschool','$highschool','$malestudent','$femalestudent','$anganwadicount','$policethana','$policechowki')";
...
<div class="section">
    ...
    <form action="fromm7.php" method="post">
    
              
      <div> 
        <br><br>
        <label>ग्राम पंचायत</label>
          <input type="text" class="input" name="grampanchayat" id="grampanchayat" oninput="getgramValue()">

          <label> जनपद पंचायत</label>
          <input type="text" class="input" name="janpatpanchayat" id="janpatpanchayat" oninput="getdataValue()">
          <label> जिला पंचायत</label>
          <input type="text" class="input" name="jilapanchayat" id="jilapanchayat" oninput="getjilaValue()">

          <label>के अंतर्गत आती है, ब्लॉक मुख्यालय से पंचायत की दूरी</label>
          
          <input type="text" class="input" name="block" id="block" oninput="getblockValue()">

          <label>कि.मी. है एवं जिला मुख्यालय से</label>
          
          <input type="text" class="input" name="gramsabha" id="gramsabha" oninput="getgramsabhaValue()">
          कि.मी. की दूरी पर स्थित है .
       
      
        <label > इस ग्राम पंचायत में कुल</label>
...
<div width="450px" height="500px">
    ...
    <h2><u><b>ग्राम पंचायत डाटा मैनेजमेंट</b></u></h2>
    <br><br>
    <h2><strong>ग्राम पंचायत की सामान्य जानकारी</strong></h2><br>
</div>
    <p style="margin-left:1em;"><b>ग्राम पंचायत</b>
    <span id="resultgram">  पंचायत </span>
    <b>जनपद पंचायत </b>
    <span id="resultjanpat"> जनपद पंचायत</span>
    <b> जिला पंचायत </b>
    <span id="resultjila"> जिला पंचायत  </span> 
    <b>के अंतर्गत आती है, ब्लॉक मुख्यालय से पंचायत की दूरी</b>
    <span id="resultblock">अध्यक्ष</span>
    <b>  कि.मी. है एवं जिला मुख्यालय से </b>
    <span id="resultzila">जिला मुख्यालय</span>
    <b> कि.मी. की दूरी पर स्थित है.</b>
    <br><br>
    <b>इस ग्राम पंचायत में कुल</b>
   ...
   <div class="col-1">
    ...
    <script>
        function getgramValue() {
            ...
            let resultIngrampanchayat = document.getElementById("resultgram");
            resultIngrampanchayat.innerText = txtgrampanchayatValue;
        }
        </script>
        <script>
        function getdataValue() {
            let txtjanpatpanchayat= document.getElementById("janpatpanchayat");
            let txtjanpatpanchayatValue = txtjanpatpanchayat.value;

            let resultInjanpatpanchayat = document.getElementById("resultjanpat");
            resultInjanpatpanchayat.innerText = txtjanpatpanchayatValue;
        }
        </script>
        <script>
        function getjilaValue() {
            let txtjilapanchayat= document.getElementById("jilapanchayat");
            let txtjilapanchayatValue = txtjilapanchayat.value;

            let resultInjilapanchayat = document.getElementById("resultjila");
            resultInjilapanchayat.innerText = txtjilapanchayatValue;
        }
        </script>
           <script>
        function getblockValue() {
            let txtblock= document.getElementById("block");
            let txtblockValue = txtblock.value;

            let resultInblock = document.getElementById("resultblock");
            resultInblock.innerText = txtblockValue;
        }
        </script>
        <script>
        function getgramsabhaValue() {
            ...
            let resultIngramsabha = document.getElementById("resultzila");
