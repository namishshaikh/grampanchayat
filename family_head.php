...
$acc_no= $_POST['acc_no'];
$adre= $_POST['adre'];
$q ="insert into family_head(name,father_name,mother_name,dob,gender,religion,caste,sub_caste,edu_quali,occupation,mob_no,sssm_id,aadhar_no,caste_certi_no,income_cert_no,pan_no,bank_name,ifsc_code,account_no,adres) values('$yname','$f_name','$m_name','$birthday','$gen','$reli_gion','$castee','$sub_cast','$education','$occu_pation','$contact','$sm_id','$adhaar_no','$caste_certificate','$income_certificate','$pan_number','$bank','$ifsc','$acc_no','$adre')";
                ...
                <form class="needs-validation" method="post">
                    ...
                    <div class="wrapper" id="wrapp">
                        ...
                        <div class="col-25">
                            ...
                            <input type="text" name="f_name" class="form-control" id="mothername" placeholder=""
                                value="" required>
                        </div>
                        <div class="col-25">
                            <label for="mothername">माता का नाम :</label>
                            <input type="text" name="m_name" class="form-control" id="mothername" placeholder=""
                                value="" required>
                        ...
                        <div class="col-25">
                            ...
                            <input type="date" name="birthday" class="form-control" id="birthday" c placeholder=""
                                value="" required>
                        ...
                        <div class="col-25">
                            ...
                            <input type="text" class="form-control" id="account_no" name="acc_no" placeholder=""
                                value="" required>
                        </div>
                        <div class="col-25">
                            <label for="pan_no">पेन क्रमांक :</label>
                            <input type="text" class="form-control" id="pan_no" name="pan_number" placeholder=""
                                value="" required>
                        </div>
                        ...
                        <div class="col-25">
                            ...
                            <input type="text" class="form-control" id="caste_certificate" name="caste_certificate"
                                value="" required>
                        </div>
                        <div class="col-25">
                        ...
                        <div class="col-25">
                            ...
                            <input type="text" class="form-control" id="samagra_id" name="sm_id" placeholder=""
                                value="">
                        </div>
                        <div class="col-25">
                    ...
                    <div class="form-input">
                        ...
                        <div class="col-252">
                            ...
                            <input type="text" class="form-control" id="beneficiary_name " placeholder="" value=""
                                required>
                        </div>
                        <div class="col-252">
